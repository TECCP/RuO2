program mk_kanamori_mf_h
!====================================================================================================
! ifort -o mk_kanamori_mf_h mk_kanamori_mf_h.f90
!
! ifort -O -o mk_kanamori_mf_h mk_kanamori_mf_h.f90 -L/opt/intel/mkl/10.2.5.035/lib/em64t -lmkl_lapack95_lp64 -lmkl_intel_lp64 -lmkl_core -lmkl_sequential -lpthread -lm
!
...
open( 90,file='hamilt_hmf',      status='unknown',form='formatted')
!open( 92,file='dos_hmf.out',     status='unknown',form='formatted')
